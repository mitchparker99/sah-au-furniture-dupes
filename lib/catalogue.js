...
// ── self-test ────────────────────────────────────────────────────────────────
// typeof-guarded: this file can be imported into non-Node environments
// (e.g. api/og.js's Vercel Edge Function) where `require` isn't a global at
// all - referencing it unguarded throws before the && even gets to `false`.
